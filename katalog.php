        ...
        <div class="container py-5">
          <div class="row g-5">
            <div class="col-lg-3 col-md-6">
              ...
              <p class="mb-2">
                <i class="fa fa-map-marker-alt me-3"></i>Makassar, Sulawesi
                Selatan
              </p>
              <p class="mb-2">
                <i class="fa fa-phone-alt me-3"></i>+62 123 456
              </p>
              <p class="mb-2">
                <i class="fa fa-envelope me-3"></i>liipa@gmail.com
              </p>
          ...
          <div class="copyright">
            <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                &copy; <a class="border-bottom" href="#">2024 Liipa'</a>, All
                Right Reserved.
